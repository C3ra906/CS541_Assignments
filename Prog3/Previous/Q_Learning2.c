...
void Q_Learning (float matrix[100][5], float reward_plot[2])
{
   int counter = 0;
   int N = 200;//5000;//Number of episodes
   int N_counter = 1;
   int M = 20;//200;//Number of steps
   int M_loop = 0;
   float alpha = 0.2;
   float gamma = 0.9;
   int epsilon = 10;//0.1
   ...
   float max_action2 = 0.0;
   float max_action3 = 0.0;
   float max_action4 = 0.0;
   int max_act_index = 0;
   struct timeval seeder;
   int num = 10;
       ...
       while (M_loop < M)
       {
           ...
           if (prob >= epsilon)//do the max action
           {
               if (max_action != 0.0)
               {
                   ...
                   else if(max_act_index == 0 && Robby.North != -1)//Move N
                   {
                   ...
                   else if (max_act_index == 1 && Robby.South != -1)//Move S
                   {
                   ...
                   else if (max_act_index == 2 && Robby.West != -1)//Move W
                   {
                   ...
                   else if (max_act_index == 3 && Robby.East != -1)//Move E
                   {
                       Robby = move_W(Robby);//Performs action
                       Robby = Update_Sensors(Robby, l_board);//Update Sensors
                       printf("Current Q value: %f \n", matrix[row_calc][3]);
                   ...
                   else if (max_act_index == 4 && Robby.Current != 0)//Pick up can
                   {
                      Robby = pick_up(Robby, l_board);//Performs action
                      Robby = Update_Sensors(Robby, l_board);//Update Sensors
                      printf("Current Q value: %f \n", matrix[row_calc][4]);
                   ...
                   else//pick second best
                   {
                       for (int k = 0; k < 5; k++)//find maxQ(s', a')
                       {
                           if (matrix[row_calc][k] != max_action && matrix[row_calc][k] > max_action2)
                           {
                               max_action2 = matrix[row_calc][k];
                               max_act_index = k;
                           }
                        }
                        if(max_act_index == 0 && Robby.North != -1)//Move N
                        {
                           Robby = move_N(Robby);//Performs action
                           Robby = Update_Sensors(Robby, l_board);//Update Sensors
                           printf("Current Q value: %f \n", matrix[row_calc][0]);
                      ...
                      for (int k = 0; k < 5; k++)//find maxQ(s', a')
                       {
                           if (matrix[row_calc][k] != max_action && matrix[row_calc][k] != max_action2 && matrix[row_calc][k] > max_action3)
                           {
                               max_action3 = matrix[row_calc][k];
                               max_act_index = k;
                           }
                        }
                        if(max_act_index == 0 && Robby.North != -1)//Move N
                      ...
                      else if (max_act_index == 4 && Robby.Current != 0)//Pick up can
                      {
                       ...
                       for (int k = 0; k < 5; k++)//find maxQ(s', a')
                       {
                           if (matrix[row_calc][k] != max_action && matrix[row_calc][k] != max_action2 && matrix[row_calc][k] != max_action3 && matrix[row_calc][k] > max_action4)
                           {
                               max_action4 = matrix[row_calc][k];
                               max_act_index = k;
                           }
                        }
                        if(max_act_index == 0 && Robby.North != -1)//Move N
...
float Standard_Dev (float t_r[200], float SD[200])
{
    float avg = 0.0;
    float calc = 0.0;
...
void Q_Test (float matrix[100][5], float reward[200])
{
   int counter = 0;
   int N = 200;//5000;//Number of episodes
   int N_counter = 1;
...
{
    //nt N = 5000;
    float Q_Matrix [100][5] = {0.0};//Q-Matrix for Robby, initialized to 0.
    float reward_plot[50] = {0.0};
    float test_rewards[200] = {0.0};
    float SD[200] = {0.0};
