...
void Q_Learning (float matrix[3][3][3][3][3][5], float reward_plot[50])//Q-Learning for Robby
{
   ...
   int epsilon = 100;//0.1 for epsilon greedy action selection
        ...
        while (M_loop < M)//Loops M steps
        {
            ...
            if (prob < epsilon || max_action == 0.0)//Act random
            {
                 ...
                 if(chosen == 0)//Move N
                 {
                     ...
                     //printf("Current Q value: %f \n", matrix[currentC][currentN][currentS][currentW][currentE][0]);
                     //printf("Math: %f + %f * (%f + %f * %f - %f )\n", matrix[currentC][currentN][currentS][currentW][currentE][0], alpha, Robby.current_r, gamma, max_action, matrix[currentC][currentN][currentS][currentW][currentE][0]);
                  ...
                  else if(chosen == 1)//Move S
                  {
                     ...
                     //printf("Current Q value: %f \n", matrix[currentC][currentN][currentS][currentW][currentE][1]);
                     //printf("Math: %f + %f * (%f + %f * %f - %f )\n", matrix[currentC][currentN][currentS][currentW][currentE][1], alpha, Robby.current_r, gamma, max_action, matrix[currentC][currentN][currentS][currentW][currentE][1]);
                  ...
                  else if(chosen == 2)//Move W
                  {
                     ...
                     //printf("Current Q value: %f \n", matrix[currentC][currentN][currentS][currentW][currentE][2]);
                     //printf("Math: %f + %f * (%f + %f * %f - %f )\n", matrix[currentC][currentN][currentS][currentW][currentE][2], alpha, Robby.current_r, gamma, max_action, matrix[currentC][currentN][currentS][currentW][currentE][2]);
                  ...
                  else if(chosen == 3)//Move E
                  {
                     ...
                     //printf("Current Q value: %f \n", matrix[currentC][currentN][currentS][currentW][currentE][3]);
                     //printf("Math: %f + %f * (%f + %f * %f - %f )\n", matrix[currentC][currentN][currentS][currentW][currentE][3], alpha, Robby.current_r, gamma, max_action, matrix[currentC][currentN][currentS][currentW][currentE][3]);
                  ...
                  else if(chosen == 4)//Pick up
                  {
                     ...
                     //printf("Current Q value: %f \n", matrix[currentC][currentN][currentS][currentW][currentE][4]);
                     //printf("Math: %f + %f * (%f + %f * %f - %f )\n", matrix[currentC][currentN][currentS][currentW][currentE][4], alpha, Robby.current_r, gamma, max_action, matrix[currentC][currentN][currentS][currentW][currentE][4]);
